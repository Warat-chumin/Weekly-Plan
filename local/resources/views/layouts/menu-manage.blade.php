            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                {{-- <li>
                    <a href="#menu-design" class="iq-waves-effect collapsed" data-toggle="collapse"
                        aria-expanded="false"><i class="ri-menu-3-line"></i><span>แผนงาน</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="menu-design" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{url('/weekly_plan').'/'.Auth::user()->employee_code}}"><i
                                    class="ri-bill-line"></i>แผนงานตัวเอง</a></li>
                        <li><a href="{{url('/weekly_plan/team/detail')}}"><i
                                    class="ri-file-copy-2-line"></i>แผนงานทีม</a></li>
                    </ul>
                </li> --}}
                <li>
                    <a href="{{url('/weekly_plan/team/detail')}}" class="iq-waves-effect"><i
                            class="ri-file-copy-2-line"></i><span>แผนงานทีม</span></a>
                </li>
                <li>
                    <a href="#mailbox" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-map-pin-line"></i><span>ลงเวลางาน</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="mailbox" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{url('/check_in')}}"><i class="ri-time-line"></i>ลงเวลางาน</a></li>
                        <li><a href="{{url('/check_in/history')}}"><i class="ri-edit-line"></i>สรุปการเข้าออกงาน</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="{{url('/setting/customer_approve')}}"><i class="ri-user-search-line"></i>อนุมัติลูกค้า</a>
                        <li><a href="{{url('/setting/customer')}}"><i class="ri-shield-user-line"></i>ลูกค้า</a>
                        <li><a href="{{url('/setting/project_approve')}}"><i class="ri-user-search-line"></i>อนุมัติโปรเจค</a>
                        <li><a href="{{url('/setting/project')}}"><i class="ri-shield-user-line"></i>โปรเจค</a>
                        <li><a href="{{url('/setting/subject')}}"><i class="ri-message-2-line"></i>หัวข้อ</a>
                    </ul>
                </li>
                <li>
